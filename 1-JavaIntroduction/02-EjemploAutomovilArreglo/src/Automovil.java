...
public class Automovil  implements  Comparable<Automovil>{
    ...
    public String verDetalle(){
     ...
     /*if(getRuedas()!=null){
            ...
            for (Rueda r: this.getRuedas()){
                detalle+="\n"+r.getFabricante()+", aro: "+r.getAro()+", ancho: "+r.getAro();
            }
        }*/
        return detalle;
    }
    ...
    public String DetallePorPersona(){
        String detallePersona =
    ...
    public float calcularConsumo(int km, float procentajeBencina){
        return km / (this.getEstanque().getCapacidad()*procentajeBencina);
    }

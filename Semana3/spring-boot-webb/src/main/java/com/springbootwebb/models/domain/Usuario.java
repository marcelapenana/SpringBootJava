...
public class Usuario {
    //me quede en la parte 6 de udemy y 3 de la explicacion de mlgar
    //@Pattern(regexp = "[0-9]{2}[.][\\d]{3}[.][\\d]{3}[-][A-Z]{1}")
    @IdentificadorRegex
    private String identificador;

    //@NotEmpty(message = "el nombre no puede ser vacio")
    private Pais pais;//definicion del objeto que tendra usuario,  manda  llamar las nuevas clases desde prueba 4
    private List<Role> roles;//manda  llamar las nuevas clases desde prueba 4
